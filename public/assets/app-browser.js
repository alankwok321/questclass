  ...
  function renderAdminPage() {
    ...
    if (form) form.onsubmit = async (e) => {
      ...
      const result = await window.QuestClassFirebase.adminUpdateUserAccount(selected.uid, {
        ...
        disabledReason: fd.get('disabledReason'),
        issueFlag: fd.get('issueFlag') === 'on',
